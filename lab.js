...
/*
  ...
  is older, and then console.log '{name} is older'. Hint: Consider what will happen
   if they are the same age. Handle this situation.
*/
...
} else {console.log('IDK who is older')}
...
if ((temperature >= 80) && (rain)){
  ...
  console.log('Just a light jacket. No umbrella.')
} else if ((temperature <= 60) && (rain === false)){
  console.log('You need a jacket but no umbrella.')
};
...
/*
  Create a for-loop that logs the numbers 0 through 10 backwards. Ex, on the first iteration it would log 10, on the second
   iteration it would log 9.
*/
